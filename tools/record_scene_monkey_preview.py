    ...
    diagnostics.append(
        {
            ...
            "abi41_soft_contact_count": int(getattr(session_diag, "abi41_soft_contact_count", 0)),
            "abi41_exact_impulse_contact_count": int(getattr(session_diag, "abi41_exact_impulse_contact_count", 0)),
            "abi41_edge_edge_contact_count": int(getattr(session_diag, "abi41_edge_edge_contact_count", 0)),
            "abi41_max_smoothed_delta": float(getattr(session_diag, "abi41_max_smoothed_delta", 0.0)),
