...
def main() -> None:
    ...
    summary = {
        ...
        "native_self_vs_pair_build_ms": float(getattr(diag, "self_vs_pair_build_ms", 0.0)),
        "native_self_vs_pair_project_ms": float(getattr(diag, "self_vs_pair_project_ms", 0.0)),
        ...
        "native_self_active_vertices": int(getattr(diag, "self_active_vertices", 0)),
        "native_self_active_samples": int(getattr(diag, "self_active_samples", 0)),
        "native_self_compaction_used": int(getattr(diag, "self_compaction_used", 0)),
        "native_self_vs_pair_count": int(getattr(diag, "self_vs_pair_count", 0)),
        "native_self_vs_pair_capacity": int(getattr(diag, "self_vs_pair_capacity", 0)),
        "native_self_vs_pair_overflow": int(getattr(diag, "self_vs_pair_overflow", 0)),
        "native_self_vs_pair_compaction_used": int(getattr(diag, "self_vs_pair_compaction_used", 0)),
